...
import static com.stepByStep.core.util.constants.PageMessageConstant.BOARD_GAME_DETAILS_PATH;
...
public class StoreController {
    ...
    @GetMapping(value = "/boardGame-{boardGameId}")
    public ModelAndView showBoardGameDetails(@PathVariable long boardGameId) throws ControllerException {
        ...
        ModelAndView modelAndView = new ModelAndView(ConfigurationPathManger.getPath(BOARD_GAME_DETAILS_PATH));
        modelAndView.addObject("boardGame", boardGame);
        return modelAndView;
    }

    @PostMapping(value = "/sortAlphabetically")
    ...
    @PostMapping(value = "/findBoardGame")
